    ...
    <div class="w-9/12 mx-auto flex flex-col items-center justify-center pt-16">
      <div class="flex flex-nowrap md:flex-row flex-col text-center gap-8 mt-16">
        <div class="card-item flex-1 flex flex-col items-center bg-gray-100 p-4">
          ...
          <div class="card-item-title font-bold text-2xl pb-1 uppercase">{{__("Address")}}</div>
          <p class="card-item-text text-gray-600">Jl. SMPN 1 Pasirmulya RT 05 RW 14 Kecamatan Pangalengan, Kabupaten Bandung, Jawa Barat</p>
        </div>
        <div class="card-item flex-1 bg-gray-100 p-4">
          ...
          <div class="card-item-title font-bold text-2xl pb-1 uppercase">{{__("Phone")}}</div>
          <p class="card-item-text text-gray-600 flex flex-row justify-around">
            <a href="tel:+6282126136031">+6282126136031</a>
          </p>
        </div>
        <div class="card-item flex-1 flex flex-col items-center bg-gray-100 p-4">
          ...
          <div class="card-item-title font-bold text-2xl pb-1 uppercase">{{__("Email")}}</div>
