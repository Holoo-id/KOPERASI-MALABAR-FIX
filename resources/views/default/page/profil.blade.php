    ...
    <div class="page-section relative">
      ...
      <div class="mx-auto flex flex-col items-center">
        ...
        <div class="section-content-wrap flex justify-center mb-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row">
            <img src="{{asset('/fe/img/pages/home/home_4.jpg')}}" alt="" class="
      ...
      <div class="mx-auto flex flex-col items-center">
        ...
        <div class="flex flex-wrap flex-row items-center sm:gap-6">
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Jayagama_Masri.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/M_Dhanny_R_N_S_Hut.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
              <div class="text-white font-black">{{__("Administrator")}}</div>
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Evi_Sri_Mulyati.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
              <div class="text-white font-black">{{__("Administrator")}}</div>
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Dr_Denie_Heriyadi_Ir_MS.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Drs_Daeng_M_Ma’mur_Thahir.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
              <div class="text-white font-black">{{__("Supervisor")}}</div>
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Ir_Muhammad_Sholeh.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
              <div class="text-white font-black">{{__("Supervisor")}}</div>
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Robbie_Sartana.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
          ...
          <div class="content-image2 flex-grow flex-1 border-4 border-white shadow-md relative">
            <img src="{{asset('/fe/img/pages/profile/organisasi/Faqih_Asyikin.jpg')}}" alt="" srcset="">
            <div class="image-content absolute bottom-0 p-4">
              <div class="text-white font-black">{{__("Manager")}}</div>
      ...
      <div class="mx-auto flex flex-col items-center">
        ...
        <div class="section-content-wrap flex justify-center min-w-full my-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row">
            <img src="{{asset('fe/img/pages/profile/lompat/2009.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
        ...
        <div class="section-content-wrap flex justify-center min-w-full">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row-reverse">
            <img src="{{asset('fe/img/pages/profile/lompat/1011.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
              ...
              <p class="py-4 text-right text-gray-800">
                {{__("Two years building the Koperasi Mitra Malabar, many unexpected things happened. Besides the surprisingly high economic opportunity, it turns out there were lots of knowledge about coffee and its ins and outs that were unknown to farmers and people.")}}
              </p>
            </div>
          </div>
        </div>
        <div class="section-content-wrap flex justify-center min-w-full my-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row">
            <img src="{{asset('fe/img/pages/profile/lompat/2012.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
              ...
              <p class="py-4 text-gray-800">
                {{__("During the two years in uplifting the village economic potential, Koperasi Mitra Malabar founders agree to establish cooperatives that accommodate Bandung's farmers and coffee processors.")}}
              </p>
              <p class="py-4 text-gray-800">
        ...
        <div class="section-content-wrap flex justify-center">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row-reverse">
            <img src="{{asset('fe/img/pages/profile/lompat/1213.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
        ...
        <div class="section-content-wrap flex justify-center my-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row">
            <img src="{{asset('fe/img/pages/profile/lompat/2013.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
        ...
        <div class="section-content-wrap flex justify-center">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row-reverse">
            <img src="{{asset('fe/img/pages/profile/lompat/13_1.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
        ...
        <div class="section-content-wrap flex justify-center my-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row">
            <img src="{{asset('fe/img/pages/profile/lompat/1415.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
        ...
        <div class="section-content-wrap flex justify-center">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row-reverse">
            <img src="{{asset('fe/img/pages/profile/lompat/1617.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
        ...
        <div class="section-content-wrap flex justify-center my-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row">
            <img src="{{asset('fe/img/pages/profile/lompat/1718.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
        ...
        <div class="section-content-wrap flex justify-center mb-28">
          <div class="flex items-center flex-col w-11/12 gap-8 lg:flex-row-reverse">
            <img src="{{asset('fe/img/pages/profile/lompat/1920.jpg')}}" alt="" class="
              border-4 border-white -my-8 flex-1 w-11/12
              lg:w-5/12 lg:min-h-full
            ">
            <div class="section-content lg:w-7/12">
