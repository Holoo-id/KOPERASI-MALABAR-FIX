    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-success card-header-icon">
          ...
          <h4 class="card-title">Product Baru</h4>
        </div>
            ...
            <div class="row px-5">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="cId" value="{{ $product->id }}" class="form-control" hidden>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-11">
                    <div class="form-group">
                      <input type="text" name="judul" class="form-control" value="{{ $product->judul }}">
                      @if($errors->has('judul'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-11">
                    <div class="form-group">
                      <textarea name="deskripsi" id="konten" class="form-control">{!! html_entity_decode ($product->deskripsi) !!}</textarea>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-11">
                      <input type="text" name="imgId" value="{{ $product->gambar_sampul }}" hidden>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-11">
                    <div class="form-group">
                      <input type="text" name="judul_gambar" class="form-control" value="{{ $product->galeri->judul }}">
