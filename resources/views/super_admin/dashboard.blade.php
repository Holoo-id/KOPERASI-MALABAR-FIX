...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="../be/img/apple-icon.png">
    ...
    <!-- CSS Files -->
    <link href="../be/css/material-dashboard.css?v=2.1.2" rel="stylesheet" />
    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="../be/demo/demo.css" rel="stylesheet" />
  </head>

  <body class="">
    <div class="wrapper ">
      <div class="sidebar" data-color="chenin" data-background-color="black" data-image="../be/img/sidebar-1.jpg">
        <!--
          Tip 1: You can change the color of the sidebar using: data-color="cobalt | chenin | green | brown | danger | moccaccino"
      ...
      -->
        ...
        <div class="sidebar-wrapper">
          <div class="user">
            <div class="photo">
              <img src="../be/img/faces/avatar.jpg" />
            </div>
            <div class="user-info">
          ...
          <div class="content">
            <div class="container-fluid">
                            ...
                            <table class="table">
                              <tbody>
                                <tr>
                                  <td>
                                    <div class="flag">
                                      <img src="../be/img/flags/US.png" </div>
                                  </td>
                                  <td>USA</td>
                                  <td class="text-right">
                                    2.920
                                ...
                                <tr>
                                  <td>
                                    <div class="flag">
                                      <img src="../be/img/flags/DE.png" </div>
                                  </td>
                                  <td>Germany</td>
                                  <td class="text-right">
                                    1.300
                                ...
                                <tr>
                                  <td>
                                    <div class="flag">
                                      <img src="../be/img/flags/AU.png" </div>
                                  </td>
                                  <td>Australia</td>
                                  <td class="text-right">
                                    760
                                ...
                                <tr>
                                  <td>
                                    <div class="flag">
                                      <img src="../be/img/flags/GB.png" </div>
                                  </td>
                                ...
                                <tr>
                                  <td>
                                    <div class="flag">
                                      <img src="../be/img/flags/RO.png" </div>
                                  </td>
                                  <td>Romania</td>
                                  <td class="text-right">
                                    600
                                ...
                                <tr>
                                  <td>
                                    <div class="flag">
                                      <img src="../be/img/flags/BR.png" </div>
                                  </td>
                                  <td>Brasil</td>
                                  <td class="text-right">
                                    550
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="card card-chart">
                    <div class="card-header card-header-chenin" data-header-animation="true">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card card-stats">
                    <div class="card-header card-header-chenin card-header-icon">
                      <div class="card-icon">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="card card-product">
                    <div class="card-header card-header-image" data-header-animation="true">
                      <a href="#pablo">
                        <img class="img" src="../be/img/card-2.jpg">
                      </a>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-md-4">
                  <div class="card card-product">
                    <div class="card-header card-header-image" data-header-animation="true">
                      <a href="#pablo">
                        <img class="img" src="../be/img/card-3.jpg">
                      </a>
                    </div>
                    <div class="card-body">
                      <div class="card-actions text-center">
                ...
                <div class="col-md-4">
                  <div class="card card-product">
                    <div class="card-header card-header-image" data-header-animation="true">
                      <a href="#pablo">
                        <img class="img" src="../be/img/card-1.jpg">
                      </a>
                    </div>
                    <div class="card-body">
                      <div class="card-actions text-center">
          ...
          <li class="adjustments-line">
            <a href="javascript:void(0)" class="switch-trigger active-color">
              <div class="badge-colors ml-auto mr-auto">
                ...
                <span class="badge filter badge-chenin active" data-color="chenin"></span>
              </div>
    ...
    <!--   Core JS Files   -->
    <script src="../be/js/core/jquery.min.js"></script>
    <script src="../be/js/core/popper.min.js"></script>
    <script src="../be/js/core/bootstrap-material-design.min.js"></script>
    <script src="../be/js/plugins/perfect-scrollbar.jquery.min.js"></script>
    <!-- Plugin for the momentJs  -->
    <script src="../be/js/plugins/moment.min.js"></script>
    <!--  Plugin for Sweet Alert -->
    <script src="../be/js/plugins/sweetalert2.js"></script>
    <!-- Forms Validations Plugin -->
    <script src="../be/js/plugins/jquery.validate.min.js"></script>
    <!-- Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
    <script src="../be/js/plugins/jquery.bootstrap-wizard.js"></script>
    <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
    <script src="../be/js/plugins/bootstrap-selectpicker.js"></script>
    <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
    <script src="../be/js/plugins/bootstrap-datetimepicker.min.js"></script>
    <!--  DataTables.net Plugin, full documentation here: https://datatables.net/  -->
    <script src="../be/js/plugins/jquery.dataTables.min.js"></script>
    <!--	Plugin for Tags, full documentation here: https://github.com/bootstrap-tagsinput/bootstrap-tagsinputs  -->
    <script src="../be/js/plugins/bootstrap-tagsinput.js"></script>
    <!-- Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput -->
    <script src="../be/js/plugins/jasny-bootstrap.min.js"></script>
    <!--  Full Calendar Plugin, full documentation here: https://github.com/fullcalendar/fullcalendar    -->
    <script src="../be/js/plugins/fullcalendar.min.js"></script>
    <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
    <script src="../be/js/plugins/jquery-jvectormap.js"></script>
    <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
    <script src="../be/js/plugins/nouislider.min.js"></script>
    <!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser support SweetAlert -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
    <!-- Library for adding dinamically elements -->
    <script src="../be/js/plugins/arrive.min.js"></script>
    <!--  Google Maps Plugin    -->
    <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
    <!-- Chartist JS -->
    <script src="../be/js/plugins/chartist.min.js"></script>
    <!--  Notifications Plugin    -->
    <script src="../be/js/plugins/bootstrap-notify.js"></script>
    <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
    <script src="../be/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
    <!-- Material Dashboard DEMO methods, don't include it in your project! -->
    <script src="../be/demo/demo.js"></script>
    <script>
    ...
    <script>
      $(document).ready(function() {
        // Javascript method's body can be found in be/js/demos.js
